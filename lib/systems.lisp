...
(defparameter *ccl-system*
  '(
    ...
    (arm64-vinsns     "ccl:bin;arm64-vinsns"     ("ccl:compiler;ARM64;arm64-vinsns.lisp"))
    ...
    (arm64-lap        "ccl:bin;arm64-lap"        ("ccl:compiler;ARM64;arm64-lap.lisp"))
    ...
    (arm64-backend    "ccl:bin;arm64-backend"    ("ccl:compiler;ARM64;arm64-backend.lisp"))
    ...
    (arm64-lapmacros  "ccl:bin;arm64-lapmacros"  ("ccl:compiler;ARM64;arm64-lapmacros.lisp"))
    ...
    (arm64-disassemble "ccl:bin;arm64-disassemble" ("ccl:compiler;ARM64;arm64-disassemble.lisp"))

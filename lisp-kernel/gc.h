...
#ifdef ARM64
/* Node fulltags: tag_cons (0x03) and gvector refs (0x60-0x7F, bits 6+5 set).
   NIL (tag 0x02) is at a fixed address and doesn't need GC marking. */
#define is_node_fulltag(f) ((f) == tag_cons || (((f) & 0x60) == 0x60))
#endif
